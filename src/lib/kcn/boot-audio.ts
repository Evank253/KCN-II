/** Procedural intelligence-console SFX. No sample files. */
  ...
  return {
    ...
    drone(on) {
      ...
      if (on) {
        ...
        droneGain.gain.value = muted ? 0 : 0.07;
        droneLfo.type = "sine";
    ...
    ping() {
      tone(920, 0.35, "sine", 0.18);
      tone(1840, 0.18, "sine", 0.06, 0.02);
    },
    tick() {
    ...
    sweep() {
      ...
      o.start(t0);
      o.stop(t0 + 0.65);
      noiseBurst(0.3, 0.06, 600);
    },
    confirm() {
      tone(523.25, 0.22, "triangle", 0.16);
      tone(783.99, 0.38, "triangle", 0.18, 0.12);
      tone(1046.5, 0.5, "sine", 0.1, 0.22);
    },
    stop() {
      this.drone(false);
    ...
    setMuted(m) {
      ...
      if (droneGain) droneGain.gain.value = m ? 0 : 0.07;
    },
  };
}
